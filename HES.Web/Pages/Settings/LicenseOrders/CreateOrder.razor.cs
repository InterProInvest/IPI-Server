        ...
        private async Task CreateNewLicenseOrderAsync()
        {
            ...
            try
            {
                ...
                var licenseOrder = new LicenseOrder()
                {
                    ...
                    StartDate = _newLicenseOrder.StartDate,
                    EndDate = _newLicenseOrder.EndDate
                };

                await LicenseService.CreateOrderAsync(licenseOrder, _newLicenseOrder.HardwareVaults);
        ...
        private async Task CreateRenewLicenseOrderAsync()
        {
            try
            {
                ...
                var licenseOrder = new LicenseOrder()
                {
                    ...
                    StartDate = null,
                    EndDate = _renewLicenseOrder.EndDate
                };
