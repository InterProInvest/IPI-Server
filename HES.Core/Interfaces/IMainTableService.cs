...
namespace HES.Core.Interfaces
{
    public interface IMainTableService<TItem, TFilter> where TFilter : class, new()
    {
        ...
        Task InitializeAsync(Func<DataLoadingOptions<TFilter>, Task<List<TItem>>> getEntities, Func<DataLoadingOptions<TFilter>, Task<int>> getEntitiesCount, Action stateHasChanged, string sortedColumn, ListSortDirection sortDirection = ListSortDirection.Ascending, string syncPropName = "Id");
